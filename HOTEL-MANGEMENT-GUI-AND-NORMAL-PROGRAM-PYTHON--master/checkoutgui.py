...
class New_Toplevel:
    ...
    def __init__(self):
        ...
        font10 = "-family {Comic Sans} -size 10 -weight normal -slant"  \
            " roman -underline 0 -overstrike 0"
        font11 = "-family {Comic Sans} -size 23 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font12 = "-family {Comic Sans} -size 24 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font9 = "-family {Comic Sans} -size 9 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
